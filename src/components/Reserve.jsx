...
export default function Reserve() {
  ...
  return (
    <section className='relative xl:px-[140px] h-fit bg-white md:bg-pattern bg-cover'>
      ...
      <div className='relative pb-[60px] lg:pb-0 pt-[60px] md:pt-[120px]  px-3 flex justify-center gap-5'>
        <div className='hidden  lg:flex justify-center items-end w-1/2'>
          <Image src={ChefImage} alt='chefImage' />
        </div>

        <div className='w-full flex flex-col items-center justify-center md:justify-normal  lg:w-1/2 px-3'>
