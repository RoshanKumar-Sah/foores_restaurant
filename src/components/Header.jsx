            ...
            <header className={`py-[10px] min-[991px]:p-[15px] fixed w-full top-0 z-30 ${header && 'bg-white'} `}>
                ...
                <div className='container flex justify-between max-w-full'>
                    ...
                    <nav className={`flex gap-4 min-[991px]:py-[5px]  text-sm leading-6 ${poppins.className}`}>
                        ...
                        <ul className={` ${isOpen ? 'animate-slideRight flex flex-col absolute top-0 left-0 z-50 w-full min-[481px]:w-1/2 h-screen bg-white text-black' : 'hidden'} min-[991px]:flex min-[991px]:items-center min-[991px]:text-white ${header && 'min-[991px]:text-black' } min-[991px]:gap-4`}>
                            ...
                            <li className={`border border-black bg-black  text-white  p-[15px]  min-[991px]:px-[8px] min-[991px]:py-[5px] min-[991px]:rounded-[3px] transition duration-400 ease-in-out  cursor-pointer ${header ? "min-[991px]:bg-black min-[991px]:border-black" : "min-[991px]:bg-transparent min-[991px]:border-white min-[991px]:hover:bg-primary min-[991px]:hover:border-primary"}`}>Reservations</li>
